      ...
      <div
        ...
        v-show="
          ...
          userStore.preference.spec_3 === 'PVC'
            ...
            : false
        "
        class="h-max w-full shadow-xl py-[4vh] px-[4vw] bg-[#f1f1f1] bg-opacity-60 rounded-md shadow-lg text-center flex flex-col gap-[4vh] relative"
      >
        <div
          class="header text-detailsContainer_heading_PC text-left z-[9] h-max w-full items-center flex justify-between text-detailsContainer_heading_PC"
        >
          Choose Your Color
          <button
              ...
              <div class="h-max w-max flex gap-[4vw]">
                ...
                >
                  <button
                    ...
                    class="carpet_details_colors_mob_add_BTN text-detailsContainer_colorLabel_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
