  ...
  >
    ...
    >
      <div class="h-max w-full flex justify-between text-[1.5rem] z-[9]">
        <!-- MOBILE -->
        <span class="text-left text-balance raised_Panel_Details_Mob-HEADING"
      ...
      <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
        ...
        <div
          :class="[
            'h-[7.2rem] w-full rounded-md border-[2px] border-[#f1f1f1] flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[1.2rem] relative cursor-pointer',
...
function toggleSelect(category) {
  ...
  setTimeout(() => {
    ...
    ENABLE_SCROLL();
    console.debug("[RaisedPanel_MOB] navigate:", {
      path: "/flooring/catalog",
      query: { type: "raised", raised: category },
    });
    router.push({
      path: "/flooring/catalog",
      query: { type: "raised", raised: category },
