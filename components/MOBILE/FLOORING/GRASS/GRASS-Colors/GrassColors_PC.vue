  ...
  >
    <transition @beforeEnter="handleDetailsDOMEntry('grass_Colors_Details_PC')">
      <div
        ...
        class="h-max w-full shadow-xl py-[6vh] px-[2vw] bg-[#f1f1f1] bg-opacity-60 rounded-md shadow-lg text-center flex flex-col gap-[4.2rem] relative"
      >
        <div
              ...
              <div class="h-max w-max flex gap-[4vw]">
                ...
                >
                  <button
                    ...
                    class="grass_details_colors_mob_add_BTN text-detailsContainer_colorLabel_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
                ...
                >
                  <button
                    ...
                    class="grass_details_colors_mob_done1_BTN text-detailsContainer_colorLabel_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1vh]"
                  >
                    Done
                  </button>
                </transition>
                <button
                  ...
                  @click="toggleSelect('done')"
                  class="carpet_details_colors_mob_done_BTN border-[2px] text-detailsContainer_colorLabel_PC rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1.8vh]"
                >
                  Done
                </button>
              </div>
