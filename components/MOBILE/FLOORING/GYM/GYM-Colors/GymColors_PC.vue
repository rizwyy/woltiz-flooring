      ...
      >
        ...
        >
          ...
          <button
            ...
            class="h-max bg-white text-gray-500 px-[2vw] py-[1vh] text-detailsContainer_clearAll_PC rounded-md flex gap-[1vw] items-center"
          >
            <!-- DESKTOP -->
          ...
          >
            ...
            >
              ...
              <div class="h-max w-max flex gap-[4vw]">
                <span
                  @click="clearColorSelections"
                  class="flex items-center justify-center cursor-pointer text-detailsContainer_label_PC gap-[.6vw] text-white hover:border-[#f1f1f1] border-[#fff9] border-md border-[2px] px-[3vw] rounded-md py-[1.8vh]"
                  >Cancel
                </span>
                <transition
                ...
                >
                  <button
                    ...
                    class="gym_details_colors_mob_add_BTN text-detailsContainer_label_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
                ...
                >
                  <button
                    ...
                    class="gym_details_colors_mob_done1_BTN text-detailsContainer_label_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1vh]"
                  >
                    Done
                  </button>
                </transition>
