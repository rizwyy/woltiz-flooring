    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            :class="[
              'h-[12vh] rubber_Budgets_Details_PC-CONTAINER opacity-0 translate-y-[20%] budgetItemPC w-[60%] shadow border-[2px] border-[#f1f1f1] rounded-full flex items-center justify-between text-[#f1f1f1] px-[4.8vw] py-[1.2vh] text-detailsContainer_colorLabel_PC relative cursor-pointer',
          ...
          >
            ...
            ></div>
            <div
              class="text-detailsContainer_colorLabel_PC flex-1 flex justify-start items-center"
            >
              <span> Value </span>
            </div>
            <div
              class="font-[400] text-detailsContainer_colorLabel_PC flex-[2] flex justify-end items-center"
            >
