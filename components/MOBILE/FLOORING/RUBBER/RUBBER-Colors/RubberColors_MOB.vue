<template>
  ...
  <transition @before-enter="handleDetailsDOMEntry('rubber_Color_Details_Mob')">
    ...
    >
      ...
      >
        <div
          class="header text-[1.8rem] text-left z-[9] h-max w-full items-center flex justify-between rubber_Color_Details_Mob-HEADING opacity-0 translate-x-[40%]"
        >
          Choose Your Color
          <button
        ...
        <div
          ...
          class="h-max w-full flex flex-col gap-[1rem] relative pt-[.4rem]"
        >
          <div
            ...
            >
              ...
              >
                <button
                  ...
                  @click="toggleSelect(customColor, 'done')"
                  class="rubber_details_colors_mob_done_BTN text-[1rem] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] border-[#f1f1f1] py-[.5rem]"
                >
                  Done
                </button>
              </transition>
              ...
              >
                <button
                  ...
                  class="rubber_details_colors_mob_add_BTN text-[1rem] border-[2px] rounded-md px-[4vw] text-[#f1f1f1] border-[#f1f1f1] py-[.5rem]"
                >
                  Add More +
                </button>
              </transition>
          ...
          <div class="color-selection flex justify-between gap-[4vw] z-[9]">
            <div
              class="color-box CustomColor h-[5.2rem] rubber_Color_Details_Mob-CONTAINER overflow-hidden opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white bg-gradient-to-br from-[#f44369] via-[#f4985a] to-[#b9dfee] rounded-md cursor-pointer relative px-[1.6vw] py-[.4rem] leading-[2.4vh]"
            ...
            <div
              ...
              class="color-box h-[5.2rem] rubber_Color_Details_Mob-CONTAINER overflow-hidden opacity-0 translate-y-[20%] w-full flex items-center justify-center text-[#fff] rounded-md cursor-pointer relative px-[1.6vw] py-[.4rem]"
            ...
            <div
              class="color-box h-[5.2rem] rubber_Color_Details_Mob-CONTAINER overflow-hidden opacity-0 translate-y-[20%] w-full flex items-center justify-center text-white rounded-md cursor-pointer relative px-[1.6vw] py-[.4rem]"
              :class="{
          ...
          <div class="color-selection flex justify-between gap-[4vw] z-[9]">
            <!-- MOBILE -->
            <div
              class="color-box h-[5.2rem] rubber_Color_Details_Mob-CONTAINER overflow-hidden opacity-0 translate-y-[20%] relative w-full flex items-center justify-center text-white rounded-md cursor-pointer px-[1.6vw] py-[.4rem]"
          ...
          <div class="color-selection flex justify-between gap-[4vw] z-[9]">
            <!-- MOBILE -->
            <div
              class="color-box h-[5.2rem] rubber_Color_Details_Mob-CONTAINER overflow-hidden opacity-0 translate-y-[20%] w-full flex items-center justify-center text-[#444] rounded-md cursor-pointer relative px-[1.6vw] py-[.4rem]"
              :class="{
        ...
        >
          ...
          <div class="w-full grid grid-cols-3 gap-[2vw]">
            ...
            <button
              @click="scrollToEl('rubberColorsContainerMOB')"
...
const toggleSelect = (color, added) => {
  if (color === "done") {
    isMultiColoredOpted.value = false;
    scrollToEl("rubberBudgetsContainerMOB");
  }
