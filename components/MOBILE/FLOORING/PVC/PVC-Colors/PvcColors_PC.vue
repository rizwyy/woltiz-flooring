<template>
  ...
  <div class="max-[990px]:hidden h-max w-screen px-[6vw]">
    <transition @before-enter="handleDetailsDOMEntry('pvc_colors_Details_PC')">
      ...
      >
        <div
          class="header text-left z-[9] h-max w-full items-center flex justify-between"
        >
          <span
        ...
        >
          ...
          >
            ...
            >
              ...
              <div class="h-max w-max flex gap-[4vw]">
                <span
                  @click="clearColorSelections"
                  class="flex items-center justify-center cursor-pointer text-detailsContainer_color_label_PC gap-[.6vw] text-white hover:border-[#f1f1f1] border-[#fff9] border-md border-[2px] px-[3vw] rounded-md py-[1.8vh]"
                  >Cancel
                </span>
                <transition
                ...
                >
                  <button
                    ...
                    class="pvc_details_colors_mob_add_BTN text-detailsContainer_color_label_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
                ...
                >
                  <button
                    ...
                    class="pvc_details_colors_mob_done1_BTN text-detailsContainer_color_label_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1vh]"
                  >
                    Done
                  </button>
                </transition>
          ...
          <div class="color-selection flex justify-between gap-[2.8vw] z-[9]">
            ...
            >
              ...
              ></div>
              <span
                class="text-detailsContainer_colorLabel_PC text-[#fff]"
