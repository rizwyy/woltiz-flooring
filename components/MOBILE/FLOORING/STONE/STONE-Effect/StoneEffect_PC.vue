          ...
          <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
            ...
            >
              ...
              <NuxtImg
                ...
                alt="#"
              />
              <span class="text-detailsContainer_label_PC">Granite</span>
            </div>
            ...
            >
              ...
              <NuxtImg
                ...
                alt="Marble"
              />
              <span class="text-detailsContainer_label_PC">Marble</span>
            </div>
            <!-- Solid  -->
          </div>
          <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
            ...
            >
              ...
              <NuxtImg
                ...
                alt=""
              />
              <span class="text-detailsContainer_label_PC">Solid</span>
            </div>
            <div
              :class="[
                'h-[28vh] overflow-hidden stone_Type_Details_PC-CONTAINER opacity-0  w-full rounded-md  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
            ...
            >
              ...
              <NuxtImg
                ...
                alt=""
              />
              <span class="text-detailsContainer_label_PC">Stone</span>
            </div>
          </div>
          <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
            <div
            ...
            >
              ...
              <NuxtImg
                ...
                alt=""
              />
              <span class="text-detailsContainer_label_PC">Wood</span>
            </div>
            <div
              :class="[
                'h-[28vh] overflow-hidden stone_Type_Details_PC-CONTAINER opacity-0  w-full rounded-md  border-[2px] border-[#f1f1f1]  w flex items-end justify-between text-[#f1f1f1] px-[1.6vw] py-[.8vh] text-[2.4vh] relative cursor-pointer',
            ...
            >
              ...
              <NuxtImg
                ...
                alt=""
              />
              <span class="text-detailsContainer_label_PC">Custom</span>
            </div>
          </div>
        </div>
      </div>
