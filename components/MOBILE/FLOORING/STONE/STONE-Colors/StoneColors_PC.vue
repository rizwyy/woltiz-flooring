      ...
      >
        ...
        >
          ...
          <button
            ...
            class="h-max bg-white text-gray-500 px-[2vw] py-[1vh] text-detailsContainer_clearAll_PC rounded-md flex gap-[.4vw] items-center"
          >
            <!-- DESKTOP -->
            <span>Clear All</span><ClearAllIcon />
          </button>
        </div>
              ...
              <div class="h-max w-max flex gap-[4vw]">
                ...
                >
                  <button
                    ...
                    class="stone_details_colors_mob_add_BTN text-detailsContainer_colorLabel_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
                ...
                >
                  <button
                    ...
                    class="stone_details_colors_mob_done1_BTN text-detailsContainer_colorLabel_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1vh]"
                  >
                    Done
                  </button>
                </transition>
                <button
                  ...
                  @click="toggleSelect('done')"
                  class="stone_details_colors_mob_done_BTN text-detailsContainer_colorLabel_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1.8vh]"
                >
                  Done
                </button>
              </div>
          ...
          <div class="color-selection grid grid-cols-3 gap-[2.8vw] z-[9]">
            ...
            >
              ...
              <div v-show="userStore.preference.color.includes(color.name)">
                <span
                  class="absolute top-1 right-1 bg-white text-gray-500 px-2 py-1 text-detailsContainer_selectedText_PC rounded-md z-[1]"
                  >Selected</span
                >
              </div>
            </div>
    ...
    >
      ...
      <div class="w-full grid grid-cols-4 gap-[2vw] pt-[4vh]">
        ...
        >
          ...
          ></div>
          <span
            class="inline px-[2vw] rounded-sm py-[.4vh] font-[500] text-[#f1f1f1] text-detailsContainer_colorLabel_PC text-center z-[9]"
          >
            {{ color }}
          </span>
          <span
