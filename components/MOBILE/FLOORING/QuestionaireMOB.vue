  ...
  >
    ...
    >
      ...
      <div v-auto-animate class="h-full w-full flex flex-col">
        <div
          :class="`h-max w-full bg-[#ededed] flex  py-[.6rem] px-[2vw] ${
        ...
        <div v-else class="h-max w-full flex flex-col gap-[1.6rem]">
          <QuestionaireCard :item="questionnaireList[7]" />
          <div
            class="h-full w-full flex flex-col gap-[1.2rem] items-center justify-center flex-[3] px-[3.2vw]"
          >
            <span v-if="showError" class="text-red-600 text-[1rem]"
            ...
            <input
              ...
              class="[appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none h-[3.2rem] rounded-md bg-inherit px-[2vw] text-[1rem] py-[.8rem] w-[100%] border-[2px] border-[#777]"
            />
            <div class="h-max w-full px-[2vw] flex justify-end pt-[1vh]">
              <button
                @click="handleQuestionaireConfirmation"
                class="text-[1.2rem] font-[500] flex items-center underline underline-offset-[.4rem]"
              >
