      ...
      <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
        ...
        >
          ...
          <NuxtImg
            ...
            alt=""
          />
          <span class="text-detailsContainer_label_PC">Fitness</span>
        </div>
        ...
        >
          ...
          <NuxtImg
            ...
            alt="Group Training"
          />
          <span class="text-detailsContainer_label_PC">Group Training</span>
        </div>
      </div>
      <div class="h-max w-full flex justify-between gap-[2vw] z-[9]">
        ...
        >
          ...
          <NuxtImg
            ...
            alt="Martial Arts"
          />
          <span class="text-detailsContainer_label_PC">Martial Arts</span>
        </div>
      </div>
...
function toggleSelect(category) {
  ...
  setTimeout(() => {
    router.push({
      ...
      query: { type: "sports", sports: category },
    });
    ENABLE_SCROLL();
