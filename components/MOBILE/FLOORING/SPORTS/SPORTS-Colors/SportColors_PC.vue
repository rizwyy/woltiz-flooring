              ...
              <div class="h-max w-max flex gap-[4vw]">
                ...
                >
                  <button
                    ...
                    class="sports_details_colors_mob_add_BTN text-detailsContainer_colorLabel_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[2vh]"
                  >
                    Add More
                  </button>
                </transition>
                ...
                >
                  <button
                    ...
                    class="sports_details_colors_mob_done1_BTN text-detailsContainer_colorLabel_PC border-[2px] rounded-md px-[4vw] text-[#f1f1f1] hover:border-[#f1f1f1] border-[#fff9] py-[1vh]"
                  >
                    Done
                  </button>
                </transition>
