  ...
  >
    ...
    >
      <span
        ...
        class="font-semibold text-detailsContainer_label_PC"
      >
        <TickCircleIcon />
      </span>
    </div>
    ...
    <div class="flex items-center gap-[2vw] w-full">
      <!-- Icon Section -->
      <div
        class="text-[2.4rem] flex-shrink-0 flex items-center justify-center"
      ...
      <div
        ...
        class="flex-1 text-start font-[500] text-[1.8rem]"
